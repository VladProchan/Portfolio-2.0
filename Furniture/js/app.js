(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider", ".some__slider")) {
            new swiper_core_Swiper(".hero__slider", {
                ...
                pagination: {
                    ...
                    renderFraction: function(currentClass, totalClass) {
                        return '<span class="' + currentClass + '"></span>' + ' <div class="hero__slider-scrollbar"></div> ' + '<span class="' + totalClass + '"></span>';
                    }
                },
                scrollbar: {
            ...
            new swiper_core_Swiper(".some__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".some__slider-button-prev",
                    nextEl: ".some__slider-button-next"
                },
                on: {}
            });
        }
