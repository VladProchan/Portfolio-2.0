(() => {
    ...
    function initSliders() {
        if (document.querySelector(".happy__slider")) new swiper_core_Swiper(".happy__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".buttons-slider__prew",
                nextEl: ".buttons-slider__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        const sliderMini = new swiper_core_Swiper(".slider-mini__slider", {
            modules: [ Thumb ],
            slidesPerView: 3,
            spaceBetween: 12,
            loop: true,
        ...
        new swiper_core_Swiper(".slider-main__slider", {
            modules: [ Thumb ],
            loop: true,
            thumbs: {
                swiper: sliderMini
    ...
    function documentAction(e) {
        ...
        if (targetElement.closest(".icons-header__button-search")) {
            search.classList.toggle("search-header--active");
            e.preventDefault();
        } else if (!targetElement.closest(".search-header")) search.classList.remove("search-header--active");
        if (targetElement.closest(".sort-casual__button")) {
            document.documentElement.classList.add("filter-open");
            e.preventDefault();
        } else if (targetElement.closest(".top-filter__button")) document.documentElement.classList.remove("filter-open");
    }
    const sliderPrice = document.querySelector(".spollers-form-filter__slider");
    if (sliderPrice) nouislider.create(sliderPrice, {
        start: [ 1e3, 4e3 ],
        tooltips: [ {
            to: function(value) {
