(() => {
    ...
    function initSliders() {
        if (document.querySelector(".content-phone-works__slider")) new swiper_core_Swiper(".content-phone-works__slider", {
        ...
        if (document.querySelector(".join__slider")) new swiper_core_Swiper(".join__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4.4,
